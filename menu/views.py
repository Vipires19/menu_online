...
def estatisticas_dashboard(request):
    ...
    Demonstra agregações do MongoDB
    """
    # Agregações usando MongoDB
    pipeline_produtos_por_categoria = [
    ...
    produtos_por_categoria = list(Produto.objects.aggregate(pipeline_produtos_por_categoria))
    
    # Estatísticas de pedidos
    total_pedidos = Pedido.objects.count()
    pedidos_pendentes = Pedido.objects(status='pendente').count()
